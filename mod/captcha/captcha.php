...
public   $captcha_config = array(
 ...
 {
     if(is_file('tmpl/'.\GOB::$tmpl.'mod/'.$this->captcha_config['view']))
     {return file_get_contents('tmpl/'.\GOB::$tmpl.'mod/captcha/'.$this->captcha_config['view'],true);}
     else{return file_get_contents('mod/captcha/view/'.$this->captcha_config['view'],true);}
 } 
